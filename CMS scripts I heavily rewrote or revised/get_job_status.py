...
-Sends GET call using job ID
-Returns job status
'''
###CHANGE LOG###
'''
version 250122.17 - initial version
'''
...
logger.info(f'{job_id} provided as the job id.', extra=extras)
...
def main():
	...
	if token_data:
		sys.stdout.write(eng_vs_token.status_check(token_data, job_id))
	else:
